...
def forward(
    ...
    result_obj = ATMForwardResult(
        ...
        height_integrated_rayleighs_smile_uvi_lbh=res["data"]["height_integrated_rayleighs_smile_uvi_lbh"],
        ...
        emission_smile_uvi_lbh=np.asarray(res["data"]["emission_smile_uvi_lbh"]) if res["data"]["emission_smile_uvi_lbh"] is not None else None,
        ...
        plasma_pedersen_conductivity=np.asarray(res["data"]["plasma_pedersen_conductivity"])
        if res["data"]["plasma_pedersen_conductivity"] is not None else None,
