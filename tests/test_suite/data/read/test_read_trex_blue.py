...
@pytest.mark.parametrize("test_dict", [
    {
        ...
        "start_time": datetime.datetime(2022, 3, 8, 6, 1),
        "end_time": datetime.datetime(2022, 3, 8, 6, 3),
        "expected_success": True,
        "expected_frames": 41
    },
    {
        ...
        "start_time": datetime.datetime(2022, 3, 8, 6, 1, 15),
        "end_time": datetime.datetime(2022, 3, 8, 6, 3),
        "expected_success": True,
        "expected_frames": 36
    },
    {
        ...
        "start_time": datetime.datetime(2022, 3, 8, 6, 1),
        "end_time": datetime.datetime(2022, 3, 8, 6, 3, 15),
        "expected_success": True,
        "expected_frames": 46
    },
    {
        ...
        "start_time": None,
        "end_time": datetime.datetime(2022, 3, 8, 6, 3, 30),
        "expected_success": True,
        "expected_frames": 71
    },
    {
        ...
        "start_time": datetime.datetime(2022, 3, 8, 6, 3, 30),
        "end_time": None,
        "expected_success": True,
        "expected_frames": 30
    },
...
@pytest.mark.data_read
def test_read_trex_blue_start_end_times(srs, all_datasets, test_dict):
    # set dataset
    dataset = find_dataset(all_datasets, "TREX_BLUE_RAW")
...
@pytest.mark.parametrize("test_dict", [
    ...
    },
    {
        ...
        "start_time": datetime.datetime(2022, 3, 8, 6, 3, 30),
        "end_time": datetime.datetime(2022, 3, 8, 6, 4, 30),
        "expected_success": True,
        "expected_frames": 100
    },
])
@pytest.mark.data_read
def test_read_trex_blue_nometa_startend(srs, all_datasets, test_dict):
    # set dataset
    dataset = find_dataset(all_datasets, "TREX_BLUE_RAW")
