...
# globals
DATA_DIR = "%s/../../../test_data/read_grid/single_channel" % (os.path.dirname(os.path.realpath(__file__)))


@pytest.mark.parametrize("test_dict", [
    {
        "filename": "20230324_0600_110km_MOSv001_grid_themis-asi.h5",
        "expected_success": True,
        "expected_frames": 20
    },
    {
        "filename": "20230324_0601_110km_MOSv001_grid_themis-asi.h5",
        "expected_success": True,
        "expected_frames": 20
    },
    {
        "filename": "20230324_0019_110km_MOSv001_grid_themis-asi.h5",
        "expected_success": True,
        "expected_frames": 15
    },
])
...
def test_read_badperms_file(srs, all_datasets):
    ...
    # set filename
    f = "%s/20230324_0605_110km_MOSv001_grid_themis-asi_badperms.h5" % (DATA_DIR)
    os.chmod(f, 0o000)
