...
def test_read_k0_single_file(srs, all_datasets, test_dict, capsys):
    # set dataset
...
@pytest.mark.data_read
def test_read_k0_multiple_files(srs, capsys, all_datasets, test_dict):
    # set dataset
    dataset = find_dataset(all_datasets, "NORSTAR_RIOMETER_K0_TXT")
...
@pytest.mark.data_read
def test_read_k0_single_file_n_parallel(srs, all_datasets, test_dict):
    # set dataset
    dataset = find_dataset(all_datasets, "NORSTAR_RIOMETER_K0_TXT")
...
@pytest.mark.data_read
def test_read_k0_multiple_files_n_parallel(srs, all_datasets, test_dict):
    # set dataset
    dataset = find_dataset(all_datasets, "NORSTAR_RIOMETER_K0_TXT")
...
@pytest.mark.data_read
def test_read_k0_first_record(srs, all_datasets, test_dict):
    # set dataset
    dataset = find_dataset(all_datasets, "NORSTAR_RIOMETER_K0_TXT")
...
@pytest.mark.data_read
def test_read_k0_no_metadata(srs, all_datasets, test_dict):
    # set dataset
    dataset = find_dataset(all_datasets, "NORSTAR_RIOMETER_K0_TXT")
...
@pytest.mark.data_read
def test_read_k0_bad_file(srs, all_datasets, test_dict):
    # set dataset
    dataset = find_dataset(all_datasets, "NORSTAR_RIOMETER_K0_TXT")
...
@pytest.mark.data_read
def test_read_k0_badperms_file(srs, all_datasets):
    # set dataset
    dataset = find_dataset(all_datasets, "NORSTAR_RIOMETER_K0_TXT")
...
@pytest.mark.data_read
def test_read_k0_readers_func(srs, all_datasets, test_dict):
    # set dataset
    dataset = find_dataset(all_datasets, "NORSTAR_RIOMETER_K0_TXT")
...
@pytest.mark.data_read
def test_read_k0_readers_func_nodataset(srs, test_dict):
    # build file list
    file_list = []
    for f in test_dict["filenames"]:
        file_list.append("%s/%s" % (DATA_DIR, f))
...
@pytest.mark.data_read
def test_read_k0_start_end_times(srs, all_datasets, test_dict):
    # set dataset
    dataset = find_dataset(all_datasets, "NORSTAR_RIOMETER_K0_TXT")
