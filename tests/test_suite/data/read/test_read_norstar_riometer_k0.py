...
# globals
DATA_DIR = "%s/../../../test_data/read_norstar_riometer/k0" % (os.path.dirname(os.path.realpath(__file__)))


@pytest.mark.parametrize("test_dict", [
    {
        "filename": "chu_canopus_dcp_rio_20050402_v0.txt",
        "expected_success": True,
        "expected_frames": 17278
    },
    {
        "filename": "norstar_k0_rio-daws_20070402_v01.txt",
        "expected_success": True,
        "expected_frames": 17279
    },
    {
        "filename": "norstar_k0_rio-fsim_20180503_v01.txt",
        "expected_success": True,
        "expected_frames": 17279
    },
    {
        "filename": "norstar_k0_rio-isll_20140202_v01.txt",
        "expected_success": True,
        "expected_frames": 17279
    },
])
@pytest.mark.data_read
def test_read_norstar_riometer_k0_single_file(srs, all_datasets, test_dict, capsys):
    # set dataset
...
@pytest.mark.data_read
def test_read_norstar_riometer_k0_multiple_files(srs, capsys, all_datasets, test_dict):
    # set dataset
    dataset = find_dataset(all_datasets, "NORSTAR_RIOMETER_K0_TXT")
    ...
    for item in data.data:
        ...
        assert item.raw_signal.shape == item.timestamp.shape
...
@pytest.mark.data_read
def test_read_norstar_riometer_k0_single_file_n_parallel(srs, all_datasets, test_dict):
    # set dataset
    dataset = find_dataset(all_datasets, "NORSTAR_RIOMETER_K0_TXT")
...
@pytest.mark.data_read
def test_read_norstar_riometer_k0_multiple_files_n_parallel(srs, all_datasets, test_dict):
    # set dataset
    dataset = find_dataset(all_datasets, "NORSTAR_RIOMETER_K0_TXT")
...
@pytest.mark.data_read
def test_read_norstar_riometer_k0_first_record(srs, all_datasets, test_dict):
    # set dataset
    dataset = find_dataset(all_datasets, "NORSTAR_RIOMETER_K0_TXT")
...
@pytest.mark.data_read
def test_read_norstar_riometer_k0_no_metadata(srs, all_datasets, test_dict):
    # set dataset
    dataset = find_dataset(all_datasets, "NORSTAR_RIOMETER_K0_TXT")
...
@pytest.mark.data_read
def test_read_norstar_riometer_k0_bad_file(srs, all_datasets, test_dict):
    # set dataset
    dataset = find_dataset(all_datasets, "NORSTAR_RIOMETER_K0_TXT")
...
@pytest.mark.data_read
def test_read_norstar_riometer_k0_badperms_file(srs, all_datasets):
    # set dataset
    dataset = find_dataset(all_datasets, "NORSTAR_RIOMETER_K0_TXT")

    # set filename
    f = "%s/norstar_k0_rio-chur_20180501_v01.badperms.txt" % (DATA_DIR)
    os.chmod(f, 0o000)
...
@pytest.mark.data_read
def test_read_norstar_riometer_k0_readers_func(srs, all_datasets, test_dict):
    # set dataset
    dataset = find_dataset(all_datasets, "NORSTAR_RIOMETER_K0_TXT")
...
@pytest.mark.data_read
def test_read_norstar_riometer_k0_readers_func_nodataset(srs, test_dict):
    # build file list
    file_list = []
    for f in test_dict["filenames"]:
        file_list.append("%s/%s" % (DATA_DIR, f))
...
@pytest.mark.parametrize("test_dict", [
    {
        ...
        "start_time": datetime.datetime(2018, 5, 1, 23, 50),
        "end_time": datetime.datetime(2018, 5, 3, 0, 5),
        "expected_success": True,
    },
    {
        "filenames": [
        ...
        "start_time": datetime.datetime(2018, 5, 1, 6, 12, 0),
        "end_time": datetime.datetime(2018, 5, 1, 6, 14, 0),
        "expected_success": True,
    },
    {
        "filenames": [
        ...
        "start_time": datetime.datetime(2018, 5, 1, 23, 55),
        "end_time": datetime.datetime(2018, 5, 2, 6, 30),
        "expected_success": True,
    },
    {
        "filenames": [
        ...
        "start_time": None,
        "end_time": datetime.datetime(2018, 5, 3, 6, 3, 30),
        "expected_success": True,
    },
    {
        "filenames": [
        ...
        "start_time": datetime.datetime(2018, 5, 1, 6, 3, 30),
        "end_time": None,
        "expected_success": True,
    },
])
@pytest.mark.data_read
def test_read_norstar_riometer_k0_start_end_times(srs, all_datasets, test_dict):
    # set dataset
    dataset = find_dataset(all_datasets, "NORSTAR_RIOMETER_K0_TXT")
