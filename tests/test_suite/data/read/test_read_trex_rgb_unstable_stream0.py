...
@pytest.mark.parametrize("test_dict", [
    ...
    {
        "filenames": [
            "20210503_06_luck_rgb-03_full.pgm.gz",
        ],
        "expected_success": False,
        "expected_frames": 1
    },
...
@pytest.mark.parametrize("test_dict", [
    {
        ...
        "start_time": datetime.datetime(2021, 5, 3, 6, 1),
        "end_time": datetime.datetime(2021, 5, 3, 6, 3),
        "expected_success": True,
        "expected_frames": 41
    },
    {
        ...
        "start_time": datetime.datetime(2021, 5, 3, 6, 1, 15),
        "end_time": datetime.datetime(2021, 5, 3, 6, 3),
        "expected_success": True,
        "expected_frames": 36
    },
    {
        ...
        "start_time": datetime.datetime(2021, 5, 3, 6, 1),
        "end_time": datetime.datetime(2021, 5, 3, 6, 3, 15),
        "expected_success": True,
        "expected_frames": 46
    },
    {
        ...
        "start_time": None,
        "end_time": datetime.datetime(2021, 5, 3, 6, 3, 30),
        "expected_success": True,
        "expected_frames": 71
    },
    {
        ...
        "start_time": datetime.datetime(2021, 5, 3, 6, 3, 30),
        "end_time": None,
        "expected_success": True,
        "expected_frames": 30
    },
...
@pytest.mark.parametrize("test_dict", [
    ...
    },
    {
        ...
        "start_time": datetime.datetime(2021, 5, 3, 6, 3, 30),
        "end_time": datetime.datetime(2021, 5, 3, 6, 4, 30),
        "expected_success": True,
        "expected_frames": 100
    },
])
