...
@pytest.mark.data_read
def test_read_trex_rgb_unstable_stream0colour_single_file_workers(srs, test_dict):
    # read file
...
@pytest.mark.data_read
def test_read_trex_rgb_unstable_stream0colour_multiple_files_workers(srs, test_dict):
    # build file list
    file_list = []
    for f in test_dict["filenames"]:
        file_list.append("%s/%s" % (DATA_DIR, f))
