...
> [!NOTE]
> This library is primarily a sub-dependency for higher-level data access and analysis support libraries PyAuroraX and PyUCRF. We recommend using those libraries for accessing and analyzing All-Sky Imager (ASI) data and RF instrument data, respectively.
