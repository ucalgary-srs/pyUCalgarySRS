...
for i in range(num_neut):
    ...
    neutral_profile_arr[4, i] = 1e6
    neutral_profile_arr[5, i] = 1e6
...
result = srs.models.atm.forward(timestamp, latitude, longitude, output, custom_neutral_profile=neutral_profile_arr)
