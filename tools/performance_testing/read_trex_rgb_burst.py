...
def main():
    ...
    start_dt = datetime.datetime(2023, 3, 24, 6, 30, 0)
    end_dt = datetime.datetime(2023, 3, 24, 6, 34, 59)
    print("[%s] Downloading data" % (datetime.datetime.now()))
    res = srs.data.download("TREX_RGB_RAW_BURST", start_dt, end_dt, site_uid="atha", progress_bar_disable=True)
